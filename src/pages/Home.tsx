...
export const Home = () => {
  ...
  const newReviews = reviews.filter((data: Reviews) => selectedBrands.includes(data.reviewItem.brand))
              ...
              return (
                <div key={index} className="review-item">
                  ...
                  <button
                    ...
                    onClick={() => {
                      OnGood(review.reviewID)
                    }}
                  >
                    ❤ {review.LikedUserCount}
                  </button>
                  <br />
                </div>
              )
